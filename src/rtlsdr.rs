use crate::regs::{Block, write_demod_reg, write_reg};
...
pub fn interface() -> Result<Option<nusb::Interface>, nusb::Error> {
...
pub fn init(interface: nusb::Interface) -> Result<nusb::Interface, TransferError> {
